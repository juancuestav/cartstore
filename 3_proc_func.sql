...
-- OBTENER un producto
--CREATE OR REPLACE FUNCTION OBTENER_PRODUCTO (ID IN PRODUCTO.PROD_ID%TYPE) RETURN SYS_REFCURSOR AS
  --c_productos SYS_REFCURSOR;
--BEGIN
  --OPEN c_productos FOR SELECT PROD_ID, PROD_DESCRIPCION, PROD_FOTO, PROD_NOMBRE, PROD_PRECIO, PROD_STOCK FROM producto WHERE PROD_ID = ID;
--  return c_productos;
--END;
--/
